...
The equation the authors found that fits the curve in Figure \ref{rothermel_moistures_damping} is:
\begin{equation}
	\label{eta_m}
	\eta _ M = 1 - 2.59 \frac{M_f}{M_x} + 5.11 (\frac{M_f}{M_x}) ^ 2 - 3.52 (\frac{M_f}{M_x}) ^ 3
\end{equation}
Where: \\
M$_f$ is the fuel moisture. \\
M$_X$ is the fuel moisture of extinction. \\
...
Similar with the moisture damping coefficient, the authors fit this curve and set that as the mineral damping coefficient. 
\begin{equation}
	\label{mineral_damping_coefficient}
	\eta _ S = 0.174(S_e) ^ {-0.19}
\end{equation}
Where: \\
S$_e$ is the effective mineral content (silica free).
